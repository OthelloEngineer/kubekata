...
<!-- <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"> -->
    <div class="max-w-md bg-white rounded-lg shadow-lg p-6">
        ...
        <div class="bg-gray-50 rounded-lg p-4">
            ...
            <!-- <div class="border border-gray-300 rounded-lg p-3 flex justify-between items-center">
                <div>
                    <span class="block font-semibold text-gray-800">nginx-7db9fccd9d-8x7jw</span>
                    <span class="text-gray-600 text-sm">Image: nginx:1.19.3</span>
                </div>
        ...
        <div class="flex space-x-4 mt-4">
            <button class="px-4 py-2 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-500 transition duration-200">
                Restart Deployment
            </button>
            <button class="px-4 py-2 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-500 transition duration-200">
                Scale Pods
