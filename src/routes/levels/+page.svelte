...
<div class="h-screen">
    ...
    <div style="padding-left: clamp(0px, 20px, 20px); padding-right: clamp(0px, 20px, 20px);" class="flex flex-wrap gap-4 mx-auto justify-start">
        {#each levelExample as superLevel}
        <div style="margin-left: clamp(5px, 5vw, 30px); margin-right: clamp(5px, 5vw, 30px)" class="bg-green-200 p-4 bg-opacity-30 outline-3 outline-dashed outline-offset-2 min-w-[250px] max-w-[250px] flex-grow outline-white rounded-md my-4">
